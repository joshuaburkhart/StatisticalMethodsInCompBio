...
for(cv_idx in seq(1:3)){
  ...
  print(c(cv_idx,x.cv_pct_lm,x.cv_mhc,x.cv_err,x.cv_svm))
  print(c(cv_idx,xq.cv_mhc,xq.cv_err,xq.cv_svm))
}
```
...
# x feat. similarity with lm filter, markov blankets, and error rates
