...
> First we'll attempt to reduce our prospective features using the wilcoxan rank sum test and a p-value limit of 0.05 for the xq dataset and 0.0001 for the x dataset. We'll store the indices of the features we discover so we can filter any new test data in the same way.
